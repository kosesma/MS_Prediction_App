...
**Dual Prediction:** Calculates Acute Relapse Risk (1-year) and Long-term Progression (2-years).

**Visual Analytics:** Generates real-time Kaplan-Meier and Cox survival curves.
# Tech Stack
Python (Streamlit, Pandas, NumPy)

**Modeling:** Cox Proportional Hazards (CoxPH) & Lifelines

**Analysis:** Time-to-Event Data Engineering
